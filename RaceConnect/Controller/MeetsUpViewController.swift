...
class MeetsUpViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "My Meets".localized
...
extension MeetsUpViewController:UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = Bundle.main.loadNibNamed("MeetupTableViewCell", owner: self, options: nil)?.first as! MeetupTableViewCell
