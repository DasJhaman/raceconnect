...
#ifndef SWIFTDATA_SWIFT_H
#define SWIFTDATA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftData",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9SwiftData8CardView")
@interface CardView : UIView
@property (nonatomic, strong) IBInspectable UIColor * _Nullable BackColor;
@property (nonatomic) IBInspectable CGFloat cornerRounding;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9SwiftData17FloatingTextField")
...
SWIFT_CLASS("_TtC9SwiftData14GeneralMethods")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9SwiftData17HighlightedButton")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9SwiftData14ShapesCardView")
@interface ShapesCardView : UIView
@property (nonatomic, strong) IBInspectable UIColor * _Nullable BackColor;
@property (nonatomic) IBInspectable CGFloat cornerRounding;
@property (nonatomic) IBInspectable CGFloat borderWidth;
@property (nonatomic, strong) IBInspectable UIColor * _Nullable borderColor;
